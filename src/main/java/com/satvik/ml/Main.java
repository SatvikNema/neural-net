...
public class Main {
    ...
    private static final String resourcesRoot = "/Users/satvik.nema/practise/nerual-net/src/main/resources/";
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<Pair<Matrix, Matrix>> mnistTrainingData = MnistReader.getDataForNN(trainImagesPath, trainLabelsPath, -1);
        ...
        MnistTrainer mnistTrainer = MnistTrainer
                .builder()
                .neuralNetwork(NNBuilder.create(inputRows, outputRows, hiddenLayersNeuronsCount))
                .iterations(ITERATIONS)
                .learningRate(ALPHA)
                .build();
        NeuralNetwork trainedNetwork;

        String modelName = resourcesRoot + String.format("%s-%s-%s.txt", mnistTrainingData.size(), ITERATIONS, ALPHA);
        ...
        List<Pair<Matrix, Matrix>> mnistTestingData = MnistReader.getDataForNN(testImagesPath, testLabelsPath, -1);
